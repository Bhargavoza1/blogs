...
Installation guide for [windows install](https://docs.docker.com/desktop/install/windows-install/).  
Installation guide for [Linux install](https://docs.docker.com/desktop/install/linux-install/).
