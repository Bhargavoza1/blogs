...
```
 ...
 these are activation function i am using in this code
...
My answer is **no**. Till now our MLP model doesn't know how to find patterns inside the logic. My answer is **no**. Till now our MLP model doesn't know how to find patterns inside the logic. 
