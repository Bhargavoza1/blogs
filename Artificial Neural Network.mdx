...
We do this a bunch of times (iterations or epochs), thanks to the discovery of backpropagation. The weights have been fine-tuned to reduce errors, and the network gets good at making predictions on both the training and validation data.
