...
These are activation functions i am using in this code.
  - Binary Step Function
    - Equation: $$f(x) = \begin{cases}1, & \text{if} \quad x \geq 0 \\0, & \text{else}\end{cases}$$
    - image <CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/blogs/main/images/ann/activation/binary.png"  alt="MLP" height={512} width={512} />
  - Sigmoid
    - Equation: $$f(x) =  \frac{\ {1} }{\ {1} + e^{-x} }$$
    - image <CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/blogs/main/images/ann/activation/sigmoid.png"  alt="MLP" height={512} width={512} />
  - Relu
    - Equation: $$f(x) =  \max(0,x)$$
    - image <CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/blogs/main/images/ann/activation/relu.png"  alt="MLP" height={512} width={512} />
  - Tenh
    - Equation: $$f(x) =  \frac{\ e^{x} - e^{-x} } {\ e^{x} + e^{-x} } $$
    - image <CustomImage src="https://raw.githubusercontent.com/Bhargavoza1/blogs/main/images/ann/activation/tanh.png"  alt="MLP" height={512} width={512} />
 

Why am I using the Binary Step Function in Multi-Layer Perceptron? We will assess the capability of our model to perform the XOR operation.
