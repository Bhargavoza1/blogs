...
To grasp the concept of backward propagation, it is essential to familiarize ourselves with several smaller concepts beforehand. I apologize for not being able to cover all the concepts here. I recommend you to revise the concepts of [Differential Calculus](https://aman.ai/primers/math/#differential-calculus)  and the concept of 
