...
<p className= 'text-[#FF0000]'>Holding for a while. Programming for Backward propagation is done you can visit this link 
[https://github.com/Bhargavoza1/simple-neural-network/tree/main/neuralnetwork](https://github.com/Bhargavoza1/simple-neural-network/tree/main/neuralnetwork).But I am stuck on how to explain derivative concepts in simple terms.</p>
