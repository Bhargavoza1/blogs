...
<div className='text-[#FF0000]'>Holding for a while. Programming for Backward propagation is done. You can visit this link [https://github.com/Bhargavoza1/simple-neural-network/tree/main/neuralnetwork](https://github.com/Bhargavoza1/simple-neural-network/tree/main/neuralnetwork).</div>
<div className='text-MyBlue'>But I am stuck on how to explain derivative concepts in simple terms.</div>
